...
bool People_manager::add_individual_face(const QString& source_img_path, const QString& extracted_face_img_path)
{
...
void People_manager::delete_individual_face(const int index)
{
